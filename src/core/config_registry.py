...
_FIELD_DEFINITIONS: Dict[str, Dict[str, Any]] = {
    ...
    "OVERNIGHT_BRIEF_ENABLED": {
        "title": "Overnight Brief Enabled",
        "description": "Enable overnight intelligence brief generation.",
        "category": "system",
        "data_type": "boolean",
        "ui_control": "switch",
        "is_sensitive": False,
    ...
    "OVERNIGHT_PRIORITY_ALERT_THRESHOLD": {
        "title": "Overnight Priority Alert Threshold",
        "description": "Minimum priority level for overnight alerts.",
        "category": "system",
        "data_type": "string",
        "ui_control": "text",
        "is_sensitive": False,
    ...
    "OVERNIGHT_SOURCE_WHITELIST": {
        "title": "Overnight Source Whitelist",
        "description": "Comma-separated source whitelist for overnight ingestion.",
        "category": "system",
        "data_type": "string",
        "ui_control": "textarea",
        "is_sensitive": False,
