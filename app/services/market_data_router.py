...
_BUCKET_PROVIDER_PRIORITY: dict[str, tuple[str, ...]] = {
    "index": (IFIND_PROVIDER_NAME, YAHOO_PROVIDER_NAME),
    "sector": (IFIND_PROVIDER_NAME, YAHOO_PROVIDER_NAME),
    "sentiment": (IFIND_PROVIDER_NAME, YAHOO_PROVIDER_NAME),
    "rates_fx": (TREASURY_PROVIDER_NAME, IFIND_PROVIDER_NAME, YAHOO_PROVIDER_NAME),
    "precious_metals": (IFIND_PROVIDER_NAME, YAHOO_PROVIDER_NAME),
    "energy": (IFIND_PROVIDER_NAME, YAHOO_PROVIDER_NAME),
    "industrial_metals": (IFIND_PROVIDER_NAME, YAHOO_PROVIDER_NAME),
    "china_proxy": (IFIND_PROVIDER_NAME, YAHOO_PROVIDER_NAME),
}
