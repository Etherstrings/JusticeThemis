        ...
        return {
            ...
            "entrypoints": {
                ...
                "api": [
                    ...
                    {"path": "/api/v1/market/external-signals/daily", "purpose": "单独查看 Polymarket/Kalshi/FedWatch/CFTC 外部信号层。"},
                    {"path": "/api/v1/analysis/daily", "purpose": "读取固定日报缓存。"},
                    {"path": "/api/v1/analysis/daily/product", "purpose": "读取面向前端的市场判断/板块判断/证据链/跟踪面板。"},
